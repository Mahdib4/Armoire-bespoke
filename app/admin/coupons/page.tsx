    ...
    <div>
      <div className="adm-head">
        <div>
          <h1>Coupon Codes</h1>
          <p>
            Codes customers type at checkout. Every rule here is checked again on the server when the
            order is placed, so a code can never be stretched further than you allow.
          </p>
        </div>
      </div>

      <CouponsManager coupons={forms} categories={categories} />
    </div>
  );
}
